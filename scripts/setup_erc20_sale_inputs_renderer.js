...
module.exports = async (callback) => {
    ...
    try {
        ...
        await Promise.all([
            ...
            await renderer.setResource("en", "website_url", "Website URL"),
            await renderer.setResource("en", "whitepaper_url", "Whitepaper URL"),
            ...
            await renderer.setResource("ko", "website_url", "웹사이트 URL"),
            await renderer.setResource("ko", "whitepaper_url", "백서 URL"),
